...
public class Formatter implements IRender {
   ...
   */
  @Deprecated
  final public static DataKey<Boolean> SETEXT_HEADER_EQUALIZE_MARKER = SETEXT_HEADING_EQUALIZE_MARKER;
  /**
   * use corrected name
   */
  @Deprecated
  final public static DataKey<EqualizeTrailingMarker> ATX_HEADER_TRAILING_MARKER = ATX_HEADING_TRAILING_MARKER;
  ...
  private class MainNodeFormatter extends NodeFormatterSubContext {
    ...
    final private DataHolder options;
    private @NotNull
    final Boolean isFormatControlEnabled;
