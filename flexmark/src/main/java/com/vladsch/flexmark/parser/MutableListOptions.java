...
public class MutableListOptions extends ListOptions {
  ...
  public @NotNull MutableListOptions setDelimiterMismatchToNewList(boolean bulletMismatchToNewList) {
  ...
  public @NotNull MutableListOptions setItemTypeMismatchToSubList(boolean itemTypeMismatchToSubList) {
    this.itemTypeMismatchToSubList = itemTypeMismatchToSubList;
    return this;
  }

  public @NotNull MutableListOptions setLooseWhenBlankLineFollowsItemParagraph(boolean looseWhenLineBlankFollowsItemParagraph) {
    this.looseWhenBlankLineFollowsItemParagraph = looseWhenLineBlankFollowsItemParagraph;
    return this;
  }

  public @NotNull MutableListOptions setLooseWhenContainsBlankLine(boolean looseWhenContainsBlankLine) {
  ...
  public @NotNull MutableListOptions setLooseWhenHasNonListChildren(boolean looseWhenHasNonListChildren) {
    this.looseWhenHasNonListChildren = looseWhenHasNonListChildren;
    return this;
  }

  public @NotNull MutableListOptions setLooseWhenHasTrailingBlankLine(boolean looseWhenHasTrailingBlankLine) {
    this.looseWhenHasTrailingBlankLine = looseWhenHasTrailingBlankLine;
    return this;
  }

  public @NotNull MutableListOptions setLooseWhenLastItemPrevHasTrailingBlankLine(boolean looseWhenLastItemPrevHasTrailingBlankLine) {
    this.looseWhenLastItemPrevHasTrailingBlankLine = looseWhenLastItemPrevHasTrailingBlankLine;
    return this;
  }

  public @NotNull MutableListOptions setLooseWhenPrevHasTrailingBlankLine(boolean looseWhenPrevHasTrailingBlankLine) {
  ...
  public @NotNull MutableListOptions setNumberedItemMarkerSuffixed(boolean numberedItemMarkerSuffixed) {
  ...
  // @formatter:off
  public @NotNull MutableListOptions setParserEmulationFamily(@NotNull ParserEmulationProfile parserEmulationProfile) {
