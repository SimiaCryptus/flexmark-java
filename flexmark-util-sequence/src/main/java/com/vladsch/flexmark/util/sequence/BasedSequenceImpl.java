...
// @formatter:off
  ...
  @NotNull
  @Override
  final public BasedSequence extendToEndOfLine(@NotNull CharPredicate eolChars) {
    return extendToEndOfLine(eolChars, false);
  }

  @NotNull
  @Override
  final public BasedSequence extendToEndOfLine(boolean includeEol) {
...
// @formatter:on
  ...
  @NotNull
  @Override
  final public BasedSequence extendToEndOfLine() {
    return extendToEndOfLine(CharPredicate.EOL, false);
  }

  @NotNull
  @Override
  final public BasedSequence extendToStartOfLine(@NotNull CharPredicate eolChars) {
    return extendToStartOfLine(eolChars, false);
  }

  @NotNull
  @Override
  final public BasedSequence extendToStartOfLine(boolean includeEol) {
    return extendToStartOfLine(CharPredicate.EOL, includeEol);
  }

  @NotNull
  @Override
  final public BasedSequence extendToStartOfLine() {
