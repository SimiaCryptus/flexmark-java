...
public abstract class IRichSequenceBase<T extends IRichSequence<T>> implements IRichSequence<T> {
  ...
  @Override
  final public boolean isNotBlank() {
  ...
  // @formatter:off
  @Override
  final public int indexOf(@NotNull CharSequence s) {
    return SequenceUtils.indexOf(this, s);
  }

  @Override
  final public int indexOf(@NotNull CharSequence s, int fromIndex) {
  ...
  @Override
  final public int indexOf(char c) {
    return SequenceUtils.indexOf(this, c);
  }

  @Override
  final public int indexOf(char c, int fromIndex) {
    return SequenceUtils.indexOf(this, c, fromIndex);
  }

  @Override
  final public int indexOfAny(@NotNull CharPredicate s) {
    return SequenceUtils.indexOfAny(this, s);
  }

  @Override
  final public int indexOfAny(@NotNull CharPredicate s, int index) {
    return SequenceUtils.indexOfAny(this, s, index);
  }

  @Override
  final public int indexOfAnyNot(@NotNull CharPredicate s) {
    return SequenceUtils.indexOfAnyNot(this, s);
  }

  @Override
  final public int indexOfAnyNot(@NotNull CharPredicate s, int fromIndex) {
    return SequenceUtils.indexOfAnyNot(this, s, fromIndex);
  }

  @Override
  final public int indexOfAnyNot(@NotNull CharPredicate s, int fromIndex, int endIndex) {
    return SequenceUtils.indexOfAnyNot(this, s, fromIndex, endIndex);
  }

  @Override
  final public int indexOfNot(char c) {
    return SequenceUtils.indexOfNot(this, c);
  }

  @Override
  final public int indexOfNot(char c, int fromIndex) {
    return SequenceUtils.indexOfNot(this, c, fromIndex);
  }

  @Override
  final public int lastIndexOf(char c) {
    return SequenceUtils.lastIndexOf(this, c);
  }

  @Override
  final public int lastIndexOf(char c, int fromIndex) {
    return SequenceUtils.lastIndexOf(this, c, fromIndex);
  }

  @Override
  final public int lastIndexOfNot(char c) {
    return SequenceUtils.lastIndexOfNot(this, c);
  }

  @Override
  final public int lastIndexOfNot(char c, int fromIndex) {
    return SequenceUtils.lastIndexOfNot(this, c, fromIndex);
  }

  @Override
  final public int lastIndexOf(@NotNull CharSequence s) {
    return SequenceUtils.lastIndexOf(this, s);
  }

  @Override
  final public int lastIndexOf(@NotNull CharSequence s, int fromIndex) {
    return SequenceUtils.lastIndexOf(this, s, fromIndex);
  }

  @Override
  final public int lastIndexOfAny(@NotNull CharPredicate s, int fromIndex) {
    return SequenceUtils.lastIndexOfAny(this, s, fromIndex);
  }

  @Override
  final public int lastIndexOfAny(@NotNull CharPredicate s) {
    return SequenceUtils.lastIndexOfAny(this, s);
  }

  @Override
  final public int lastIndexOfAnyNot(@NotNull CharPredicate s) {
    return SequenceUtils.lastIndexOfAnyNot(this, s);
  }

  @Override
  final public int lastIndexOfAnyNot(@NotNull CharPredicate s, int fromIndex) {
    return SequenceUtils.lastIndexOfAnyNot(this, s, fromIndex);
  }

  @Override
  final public int lastIndexOfAnyNot(@NotNull CharPredicate s, int startIndex, int fromIndex) {
  ...
  // @formatter:off
  @Override
  final public int countOfSpaceTab() {
    return SequenceUtils.countOfSpaceTab(this);
  }

  @Override
  final public int countOfNotSpaceTab() {
    return SequenceUtils.countOfNotSpaceTab(this);
  }

  @Override
  final public int countOfWhitespace() {
    return SequenceUtils.countOfWhitespace(this);
  }

  @Override
  final public int countOfNotWhitespace() {
    return SequenceUtils.countOfNotWhitespace(this);
  }
  // @formatter:on

  @Override
  final public int countOfAny(@NotNull CharPredicate chars, int fromIndex) {
    return SequenceUtils.countOfAny(this, chars, fromIndex);
  }

  @Override
  final public int countOfAny(@NotNull CharPredicate chars) {
    return SequenceUtils.countOfAny(this, chars);
  }

  @Override
  final public int countOfAnyNot(@NotNull CharPredicate chars, int fromIndex) {
    return SequenceUtils.countOfAnyNot(this, chars, fromIndex);
  }

  @Override
  final public int countOfAnyNot(@NotNull CharPredicate chars) {
  ...
  @Override
  final public int countOfAnyNot(@NotNull CharPredicate chars, int startIndex, int endIndex) {
    return SequenceUtils.countOfAnyNot(this, chars, startIndex, endIndex);
  }

  // @formatter:off
  @Override
  final public int countLeading(@NotNull CharPredicate chars) {
    return SequenceUtils.countLeading(this, chars);
  }

  @Override
  final public int countLeading(@NotNull CharPredicate chars, int fromIndex) {
    return SequenceUtils.countLeading(this, chars, fromIndex);
  }

  @Override
  final public int countLeadingNot(@NotNull CharPredicate chars) {
    return SequenceUtils.countLeadingNot(this, chars);
  }

  @Override
  final public int countLeadingNot(@NotNull CharPredicate chars, int fromIndex) {
    return SequenceUtils.countLeadingNot(this, chars, fromIndex);
  }

  @Override
  final public int countTrailing(@NotNull CharPredicate chars) {
    return SequenceUtils.countTrailing(this, chars);
  }

  @Override
  final public int countTrailing(@NotNull CharPredicate chars, int fromIndex) {
    return SequenceUtils.countTrailing(this, chars, fromIndex);
  }

  @Override
  final public int countTrailingNot(@NotNull CharPredicate chars) {
    return SequenceUtils.countTrailingNot(this, chars);
  }

  @Override
  final public int countTrailingNot(@NotNull CharPredicate chars, int fromIndex) {
    return SequenceUtils.countTrailingNot(this, chars, fromIndex);
  }

  @Override
  final public int countLeadingNot(@NotNull CharPredicate chars, int startIndex, int endIndex) {
    return SequenceUtils.countLeadingNot(this, chars, startIndex, endIndex);
  }

  @Override
  final public int countTrailingNot(@NotNull CharPredicate chars, int startIndex, int endIndex) {
  ...
  @Override
  final public int countTrailingWhitespace() {
    return SequenceUtils.countTrailingWhitespace(this);
  }

  @Override
  final public int countTrailingNotWhitespace() {
    return SequenceUtils.countTrailingNotWhitespace(this);
  }

  @Override
  final public int countTrailingWhitespace(int fromIndex) {
    return SequenceUtils.countTrailingWhitespace(this, fromIndex);
  }

  @Override
  final public int countTrailingNotWhitespace(int fromIndex) {
    return SequenceUtils.countTrailingNotWhitespace(this, fromIndex);
  }

  @Override
  final public int countTrailingWhitespace(int startIndex, int fromIndex) {
    return SequenceUtils.countTrailingWhitespace(this, startIndex, fromIndex);
  }

  @Override
  final public int countTrailingNotWhitespace(int startIndex, int fromIndex) {
  ...
  @NotNull
  @Override
  final public T trimStart(@NotNull CharPredicate chars) {
    return subSequence(trimStartRange(0, chars));
  }

  @NotNull
  @Override
  final public T trimmedStart(@NotNull CharPredicate chars) {
    return trimmedStart(0, chars);
  }

  @NotNull
  @Override
  final public T trimEnd(@NotNull CharPredicate chars) {
    return trimEnd(0, chars);
  }

  @NotNull
  @Override
  final public T trimmedEnd(@NotNull CharPredicate chars) {
    return trimmedEnd(0, chars);
  }

  @NotNull
  @Override
  final public T trim(@NotNull CharPredicate chars) {
    return trim(0, chars);
  }

  @NotNull
  @Override
  final public Pair<T, T> trimmed(@NotNull CharPredicate chars) {
    return trimmed(0, chars);
  }

  @NotNull
  @Override
  final public T trimStart(int keep) {
    return trimStart(keep, CharPredicate.WHITESPACE);
  }

  @NotNull
  @Override
  final public T trimmedStart(int keep) {
    return trimmedStart(keep, CharPredicate.WHITESPACE);
  }

  @NotNull
  @Override
  final public T trimEnd(int keep) {
    return trimEnd(keep, CharPredicate.WHITESPACE);
  }

  @NotNull
  @Override
  final public T trimmedEnd(int keep) {
    return trimmedEnd(keep, CharPredicate.WHITESPACE);
  }

  @NotNull
  @Override
  final public T trim(int keep) {
    return trim(keep, CharPredicate.WHITESPACE);
  }

  @NotNull
  @Override
  final public Pair<T, T> trimmed(int keep) {
  ...
  @NotNull
  @Override
  final public T trimStart(int keep, @NotNull CharPredicate chars) {
    return subSequence(trimStartRange(keep, chars));
  }

  @NotNull
  @Override
  final public T trimmedStart(int keep, @NotNull CharPredicate chars) {
    return subSequenceBefore(trimStartRange(keep, chars));
  }

  @NotNull
  @Override
  final public T trimEnd(int keep, @NotNull CharPredicate chars) {
    return subSequence(trimEndRange(keep, chars));
  }

  @NotNull
  @Override
  final public T trimmedEnd(int keep, @NotNull CharPredicate chars) {
    return subSequenceAfter(trimEndRange(keep, chars));
  }

  @NotNull
  @Override
  final public T trim(int keep, @NotNull CharPredicate chars) {
    return subSequence(trimRange(keep, chars));
  }

  @NotNull
  @Override
  final public Pair<T, T> trimmed(int keep, @NotNull CharPredicate chars) {
  ...
  @NotNull
  @Override
  final public Range trimStartRange(@NotNull CharPredicate chars) {
    return SequenceUtils.trimStartRange(this, chars);
  }

  @NotNull
  @Override
  final public Range trimEndRange(@NotNull CharPredicate chars) {
    return SequenceUtils.trimEndRange(this, chars);
  }

  @NotNull
  @Override
  final public Range trimRange(@NotNull CharPredicate chars) {
  ...
  @NotNull
  @Override
  final public Range trimStartRange(int keep) {
    return SequenceUtils.trimStartRange(this, keep);
  }

  @NotNull
  @Override
  final public Range trimEndRange(int keep) {
    return SequenceUtils.trimEndRange(this, keep);
  }

  @NotNull
  @Override
  final public Range trimRange(int keep) {
    return SequenceUtils.trimRange(this, keep);
  }

  @NotNull
  @Override
  final public Range trimStartRange() {
    return SequenceUtils.trimStartRange(this);
  }

  @NotNull
  @Override
  final public Range trimEndRange() {
    return SequenceUtils.trimEndRange(this);
  }

  @NotNull
  @Override
  final public Range trimRange() {
  ...
  @Override
  final public int startOfDelimitedByAnyNot(@NotNull CharPredicate s, int index) {
    return startOfDelimitedByAny(s.negate(), index);
  }

  @Override
  final public int endOfDelimitedByAnyNot(@NotNull CharPredicate s, int index) {
  ...
  @Override
  @NotNull
  final public Range lineRangeAt(int index) {
    return SequenceUtils.lineRangeAt(this, index);
  }

  @Override
  @NotNull
  final public Range lineRangeAtAnyEOL(int index) {
  ...
  @NotNull
  @Override
  final public Range leadingBlankLinesRange() {
    return SequenceUtils.leadingBlankLinesRange(this);
  }

  @NotNull
  @Override
  final public Range leadingBlankLinesRange(int startIndex) {
  ...
  @NotNull
  @Override
  final public Range leadingBlankLinesRange(int fromIndex, int endIndex) {
    return SequenceUtils.leadingBlankLinesRange(this, fromIndex, endIndex);
  }

  @NotNull
  @Override
  final public Range trailingBlankLinesRange() {
    return SequenceUtils.trailingBlankLinesRange(this);
  }

  @NotNull
  @Override
  final public Range trailingBlankLinesRange(int fromIndex) {
    return SequenceUtils.trailingBlankLinesRange(this, fromIndex);
  }

  @NotNull
  @Override
  final public Range trailingBlankLinesRange(int startIndex, int fromIndex) {
  ...
  @NotNull
  @Override
  final public List<Range> blankLinesRemovedRanges() {
    return SequenceUtils.blankLinesRemovedRanges(this);
  }

  @NotNull
  @Override
  final public List<Range> blankLinesRemovedRanges(int fromIndex) {
    return SequenceUtils.blankLinesRemovedRanges(this, fromIndex);
  }

  @NotNull
  @Override
  final public List<Range> blankLinesRemovedRanges(int fromIndex, int endIndex) {
  ...
  @NotNull
  @Override
  final public T ifNull(@NotNull T other) {
    return isNull() ? other : (T) this;
  }

  @NotNull
  @Override
  final public T ifNullEmptyAfter(@NotNull T other) {
    return isNull() ? other.subSequence(other.length(), other.length()) : (T) this;
  }

  @NotNull
  @Override
  final public T ifNullEmptyBefore(@NotNull T other) {
  ...
  @NotNull
  @Override
  final public T nullIfNot(@NotNull BiPredicate<? super T, ? super CharSequence> predicate, CharSequence... matches) {
    return nullIf(predicate.negate(), matches);
  }

  @NotNull
  @Override
  final public T nullIf(@NotNull Predicate<? super CharSequence> predicate, CharSequence... matches) {
    return nullIf((o1, o2) -> predicate.test(o2), matches);
  }

  @NotNull
  @Override
  final public T nullIfNot(@NotNull Predicate<? super CharSequence> predicate, CharSequence... matches) {
  ...
  @NotNull
  @Override
  final public T nullIfNotStartsWith(CharSequence... matches) {
  ...
  @NotNull
  @Override
  final public T nullIfNotEndsWith(CharSequence... matches) {
    return nullIfNot((Predicate<? super CharSequence>) this::endsWith, matches);
  }

  @NotNull
  @Override
  final public T nullIfStartsWithIgnoreCase(CharSequence... matches) {
    return nullIf((Predicate<? super CharSequence>) this::startsWithIgnoreCase, matches);
  }

  @NotNull
  @Override
  final public T nullIfNotStartsWithIgnoreCase(CharSequence... matches) {
  ...
  @NotNull
  @Override
  final public T nullIfEndsWithIgnoreCase(CharSequence... matches) {
    return nullIf((Predicate<? super CharSequence>) this::endsWithIgnoreCase, matches);
  }

  @NotNull
  @Override
  final public T nullIfNotEndsWithIgnoreCase(CharSequence... matches) {
    return nullIfNot((Predicate<? super CharSequence>) this::endsWithIgnoreCase, matches);
  }

  @NotNull
  @Override
  final public T nullIfStartsWith(boolean ignoreCase, CharSequence... matches) {
    return nullIf((Predicate<? super CharSequence>) prefix -> startsWith(prefix, ignoreCase), matches);
  }

  @NotNull
  @Override
  final public T nullIfNotStartsWith(boolean ignoreCase, CharSequence... matches) {
    return nullIfNot((Predicate<? super CharSequence>) prefix -> startsWith(prefix, ignoreCase), matches);
  }

  @NotNull
  @Override
  final public T nullIfEndsWith(boolean ignoreCase, CharSequence... matches) {
    return nullIf((Predicate<? super CharSequence>) suffix -> endsWith(suffix, ignoreCase), matches);
  }

  @NotNull
  @Override
  final public T nullIfNotEndsWith(boolean ignoreCase, CharSequence... matches) {
    return nullIfNot((Predicate<? super CharSequence>) suffix -> endsWith(suffix, ignoreCase), matches);
  }
  ...
  @Override
  final public boolean endsWith(@NotNull CharSequence suffix) {
    return SequenceUtils.endsWith(this, suffix);
  }

  @Override
  final public boolean endsWith(@NotNull CharSequence suffix, boolean ignoreCase) {
    return SequenceUtils.endsWith(this, suffix, ignoreCase);
  }

  @Override
  final public boolean startsWith(@NotNull CharSequence prefix) {
    return SequenceUtils.startsWith(this, prefix);
  }

  @Override
  final public boolean startsWith(@NotNull CharSequence prefix, boolean ignoreCase) {
    return SequenceUtils.startsWith(this, prefix, ignoreCase);
  }

  @Override
  final public boolean endsWith(@NotNull CharPredicate chars) {
    return SequenceUtils.endsWith(this, chars);
  }

  @Override
  final public boolean startsWith(@NotNull CharPredicate chars) {
    return SequenceUtils.startsWith(this, chars);
  }

  @Override
  final public boolean endsWithEOL() {
    return SequenceUtils.endsWithEOL(this);
  }

  @Override
  final public boolean endsWithAnyEOL() {
    return SequenceUtils.endsWithAnyEOL(this);
  }

  @Override
  final public boolean endsWithSpace() {
    return SequenceUtils.endsWithSpace(this);
  }

  @Override
  final public boolean endsWithSpaceTab() {
    return SequenceUtils.endsWithSpaceTab(this);
  }

  @Override
  final public boolean endsWithWhitespace() {
    return SequenceUtils.endsWithWhitespace(this);
  }

  @Override
  final public boolean startsWithEOL() {
    return SequenceUtils.startsWithEOL(this);
  }

  @Override
  final public boolean startsWithAnyEOL() {
    return SequenceUtils.startsWithAnyEOL(this);
  }

  @Override
  final public boolean startsWithSpace() {
    return SequenceUtils.startsWithSpace(this);
  }

  @Override
  final public boolean startsWithSpaceTab() {
    return SequenceUtils.startsWithSpaceTab(this);
  }

  @Override
  final public boolean startsWithWhitespace() {
    return SequenceUtils.startsWithWhitespace(this);
  }

  @NotNull
  @Override
  final public T removeSuffix(@NotNull CharSequence suffix) {
    return !endsWith(suffix) ? (T) this : subSequence(0, length() - suffix.length());
  }

  @NotNull
  @Override
  final public T removePrefix(@NotNull CharSequence prefix) {
    return !startsWith(prefix) ? (T) this : subSequence(prefix.length(), length());
  }

  @NotNull
  @Override
  final public T removeProperSuffix(@NotNull CharSequence suffix) {
    return length() <= suffix.length() || !endsWith(suffix) ? (T) this : subSequence(0, length() - suffix.length());
  }

  @NotNull
  @Override
  final public T removeProperPrefix(@NotNull CharSequence prefix) {
    return length() <= prefix.length() || !startsWith(prefix) ? (T) this : subSequence(prefix.length(), length());
  }

  @Override
  final public boolean endsWithIgnoreCase(@NotNull CharSequence suffix) {
    return length() > 0 && matchCharsReversed(suffix, length() - 1, true);
  }

  @Override
  final public boolean startsWithIgnoreCase(@NotNull CharSequence prefix) {
    return length() > 0 && matchChars(prefix, 0, true);
  }

  @NotNull
  @Override
  final public T removeSuffixIgnoreCase(@NotNull CharSequence suffix) {
    return !endsWithIgnoreCase(suffix) ? (T) this : subSequence(0, length() - suffix.length());
  }

  @NotNull
  @Override
  final public T removePrefixIgnoreCase(@NotNull CharSequence prefix) {
    return !startsWithIgnoreCase(prefix) ? (T) this : subSequence(prefix.length(), length());
  }

  @NotNull
  @Override
  final public T removeProperSuffixIgnoreCase(@NotNull CharSequence suffix) {
    return length() <= suffix.length() || !endsWithIgnoreCase(suffix) ? (T) this : subSequence(0, length() - suffix.length());
  }

  @NotNull
  @Override
  final public T removeProperPrefixIgnoreCase(@NotNull CharSequence prefix) {
    return length() <= prefix.length() || !startsWithIgnoreCase(prefix) ? (T) this : subSequence(prefix.length(), length());
  }

  @NotNull
  @Override
  final public T removeSuffix(@NotNull CharSequence suffix, boolean ignoreCase) {
    return !endsWith(suffix, ignoreCase) ? (T) this : subSequence(0, length() - suffix.length());
  }

  @NotNull
  @Override
  final public T removePrefix(@NotNull CharSequence prefix, boolean ignoreCase) {
    return !startsWith(prefix, ignoreCase) ? (T) this : subSequence(prefix.length(), length());
  }

  @NotNull
  @Override
  final public T removeProperSuffix(@NotNull CharSequence suffix, boolean ignoreCase) {
    return length() <= suffix.length() || !endsWith(suffix, ignoreCase) ? (T) this : subSequence(0, length() - suffix.length());
  }

  @NotNull
  @Override
  final public T removeProperPrefix(@NotNull CharSequence prefix, boolean ignoreCase) {
  ...
  // @formatter:off
  @Override
  final public boolean matches(@NotNull CharSequence chars, boolean ignoreCase) {
    return SequenceUtils.matches(this, chars, ignoreCase);
  }

  @Override
  final public boolean matches(@NotNull CharSequence chars) {
    return SequenceUtils.matches(this, chars);
  }

  @Override
  final public boolean matchesIgnoreCase(@NotNull CharSequence chars) {
  ...
  @Override
  final public boolean matchChars(@NotNull CharSequence chars, int startIndex) {
    return SequenceUtils.matchChars(this, chars, startIndex);
  }

  @Override
  final public boolean matchCharsIgnoreCase(@NotNull CharSequence chars, int startIndex) {
    return SequenceUtils.matchCharsIgnoreCase(this, chars, startIndex);
  }

  @Override
  final public boolean matchChars(@NotNull CharSequence chars, boolean ignoreCase) {
    return SequenceUtils.matchChars(this, chars, ignoreCase);
  }

  @Override
  final public boolean matchChars(@NotNull CharSequence chars) {
    return SequenceUtils.matchChars(this, chars);
  }

  @Override
  final public boolean matchCharsIgnoreCase(@NotNull CharSequence chars) {
    return SequenceUtils.matchCharsIgnoreCase(this, chars);
  }

  @Override
  final public boolean matchCharsReversed(@NotNull CharSequence chars, int endIndex, boolean ignoreCase) {
    return SequenceUtils.matchCharsReversed(this, chars, endIndex, ignoreCase);
  }

  @Override
  final public boolean matchCharsReversed(@NotNull CharSequence chars, int endIndex) {
    return SequenceUtils.matchCharsReversed(this, chars, endIndex);
  }

  @Override
  final public boolean matchCharsReversedIgnoreCase(@NotNull CharSequence chars, int endIndex) {
    return SequenceUtils.matchCharsReversedIgnoreCase(this, chars, endIndex);
  }

  @Override
  final public int matchedCharCount(@NotNull CharSequence chars, int startIndex, int endIndex, boolean ignoreCase) {
    return SequenceUtils.matchedCharCount(this, chars, startIndex, endIndex, ignoreCase);
  }

  @Override
  final public int matchedCharCount(@NotNull CharSequence chars, int startIndex, boolean ignoreCase) {
    return SequenceUtils.matchedCharCount(this, chars, startIndex, ignoreCase);
  }

  @Override
  final public int matchedCharCount(@NotNull CharSequence chars, int startIndex, int endIndex) {
    return SequenceUtils.matchedCharCount(this, chars, startIndex, endIndex);
  }

  @Override
  final public int matchedCharCount(@NotNull CharSequence chars, int startIndex) {
    return SequenceUtils.matchedCharCount(this, chars, startIndex);
  }

  @Override
  final public int matchedCharCountIgnoreCase(@NotNull CharSequence chars, int startIndex) {
    return SequenceUtils.matchedCharCountIgnoreCase(this, chars, startIndex);
  }

  @Override
  final public int matchedCharCountIgnoreCase(@NotNull CharSequence chars, int startIndex, int endIndex) {
    return SequenceUtils.matchedCharCountIgnoreCase(this, chars, startIndex, endIndex);
  }

  @Override
  final public int matchedCharCountReversedIgnoreCase(@NotNull CharSequence chars, int startIndex, int fromIndex) {
    return SequenceUtils.matchedCharCountReversedIgnoreCase(this, chars, startIndex, fromIndex);
  }

  @Override
  final public int matchedCharCountReversed(@NotNull CharSequence chars, int startIndex, int fromIndex) {
    return SequenceUtils.matchedCharCountReversed(this, chars, startIndex, fromIndex);
  }

  @Override
  final public int matchedCharCountReversed(@NotNull CharSequence chars, int fromIndex, boolean ignoreCase) {
    return SequenceUtils.matchedCharCountReversed(this, chars, fromIndex, ignoreCase);
  }

  @Override
  final public int matchedCharCountReversed(@NotNull CharSequence chars, int fromIndex) {
    return SequenceUtils.matchedCharCountReversed(this, chars, fromIndex);
  }

  @Override
  final public int matchedCharCountReversedIgnoreCase(@NotNull CharSequence chars, int fromIndex) {
  ...
  @NotNull
  @Override
  final public List<T> splitList(@NotNull CharSequence delimiter) {
    return SequenceUtils.splitList((T) this, delimiter, 0, 0, null);
  }

  @NotNull
  @Override
  final public List<T> splitList(@NotNull CharSequence delimiter, int limit, boolean includeDelims, @Nullable CharPredicate trimChars) {
    return SequenceUtils.splitList((T) this, delimiter, limit, includeDelims ? SequenceUtils.SPLIT_INCLUDE_DELIMS : 0, trimChars);
  }

  @NotNull
  @Override
  final public List<T> splitList(@NotNull CharSequence delimiter, int limit, int flags) {
    return SequenceUtils.splitList((T) this, delimiter, limit, flags, null);
  }

  @NotNull
  @Override
  final public List<T> splitList(@NotNull CharSequence delimiter, boolean includeDelims, @Nullable CharPredicate trimChars) {
    return SequenceUtils.splitList((T) this, delimiter, 0, includeDelims ? SequenceUtils.SPLIT_INCLUDE_DELIMS : 0, trimChars);
  }

  // NOTE: these default to including delimiters as part of split item
  @NotNull
  @Override
  final public List<T> splitListEOL() {
    return SequenceUtils.splitList((T) this, SequenceUtils.EOL, 0, SequenceUtils.SPLIT_INCLUDE_DELIMS, null);
  }

  @NotNull
  @Override
  final public List<T> splitListEOL(boolean includeDelims) {
    return SequenceUtils.splitList((T) this, SequenceUtils.EOL, 0, includeDelims ? SequenceUtils.SPLIT_INCLUDE_DELIMS : 0, null);
  }

  @NotNull
  @Override
  final public List<T> splitListEOL(boolean includeDelims, @Nullable CharPredicate trimChars) {
    return SequenceUtils.splitList((T) this, SequenceUtils.EOL, 0, includeDelims ? SequenceUtils.SPLIT_INCLUDE_DELIMS : 0, trimChars);
  }
  ...
  @NotNull
  @Override
  final public T[] splitEOL() {
    return split(SequenceUtils.EOL, 0, SequenceUtils.SPLIT_INCLUDE_DELIMS, null);
  }

  @NotNull
  @Override
  final public T[] splitEOL(boolean includeDelims) {
    return split(SequenceUtils.EOL, 0, includeDelims ? SequenceUtils.SPLIT_INCLUDE_DELIMS : 0, null);
  }

  @NotNull
  @Override
  final public T[] split(@NotNull CharSequence delimiter, boolean includeDelims, @Nullable CharPredicate trimChars) {
    return split(delimiter, 0, includeDelims ? SequenceUtils.SPLIT_INCLUDE_DELIMS : 0, trimChars);
  }

  @NotNull
  @Override
  final public T[] split(@NotNull CharSequence delimiter) {
    return split(delimiter, 0, 0, null);
  }

  @NotNull
  @Override
  final public T[] split(@NotNull CharSequence delimiter, int limit, boolean includeDelims, @Nullable CharPredicate trimChars) {
    return split(delimiter, limit, includeDelims ? SequenceUtils.SPLIT_INCLUDE_DELIMS : 0, trimChars);
  }

  @NotNull
  @Override
  final public T[] split(@NotNull CharSequence delimiter, int limit, int flags) {
  ...
  final public T[] split(@NotNull CharSequence delimiter, int limit, int flags, @Nullable CharPredicate trimChars) {
    return SequenceUtils.splitList((T) this, delimiter, limit, flags, trimChars).toArray(emptyArray());
  }
  // @formatter:on
  ...
  @NotNull
  @Override
  final public T appendTo(@NotNull StringBuilder out, @Nullable CharMapper charMapper) {
    return appendTo(out, charMapper, 0, length());
  }

  @NotNull
  @Override
  final public T appendTo(@NotNull StringBuilder out, @Nullable CharMapper charMapper, int startIndex) {
  ...
  @NotNull
  @Override
  final public T appendTo(@NotNull StringBuilder out, int startIndex) {
  ...
  @NotNull
  @Override
  final public T appendRangesTo(@NotNull StringBuilder out, @Nullable CharMapper charMapper, Range... ranges) {
    return appendRangesTo(out, charMapper, new ArrayIterable<>(ranges));
  }

  @NotNull
  @Override
  final public T appendRangesTo(@NotNull StringBuilder out, Range... ranges) {
  ...
  @Override
  @NotNull
  final public T appendEOL() {
    return suffixWith(SequenceUtils.EOL);
  }

  @Override
  @NotNull
  final public T suffixWithEOL() {
    return suffixWith(SequenceUtils.EOL);
  }

  @Override
  @NotNull
  final public T prefixWithEOL() {
    return prefixWith(SequenceUtils.EOL);
  }

  @Override
  @NotNull
  final public T prefixOnceWithEOL() {
    return prefixOnceWith(SequenceUtils.EOL);
  }

  @Override
  @NotNull
  final public T suffixOnceWithEOL() {
    return suffixOnceWith(SequenceUtils.EOL);
  }

  @Override
  @NotNull
  final public T appendSpace() {
    return suffixWith(SequenceUtils.SPACE);
  }

  @Override
  @NotNull
  final public T suffixWithSpace() {
    return suffixWith(SequenceUtils.SPACE);
  }

  @Override
  @NotNull
  final public T prefixWithSpace() {
    return prefixWith(SequenceUtils.SPACE);
  }

  @Override
  @NotNull
  final public T appendSpaces(int count) {
    return suffixWith(RepeatedSequence.ofSpaces(count));
  }

  @Override
  @NotNull
  final public T suffixWithSpaces(int count) {
    return suffixWith(RepeatedSequence.ofSpaces(count));
  }

  @Override
  @NotNull
  final public T prefixWithSpaces(int count) {
    return prefixWith(RepeatedSequence.ofSpaces(count));
  }

  @Override
  @NotNull
  final public T prefixOnceWithSpace() {
    return prefixOnceWith(SequenceUtils.SPACE);
  }

  @Override
  @NotNull
  final public T suffixOnceWithSpace() {
