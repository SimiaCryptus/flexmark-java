...
public interface LineAppendable extends Appendable, Iterable<LineInfo> {
  ...
  @Deprecated
  int CONVERT_TABS = F_CONVERT_TABS;
  @Deprecated
  int COLLAPSE_WHITESPACE = F_COLLAPSE_WHITESPACE;
  @Deprecated
  int TRIM_TRAILING_WHITESPACE = F_TRIM_TRAILING_WHITESPACE;
  @Deprecated
  int PASS_THROUGH = F_PASS_THROUGH;
  /**
   * @deprecated ALLOW_LEADING_WHITESPACE is now inverted and named F_TRIM_LEADING_WHITESPACE
   */
  @Deprecated
  int ALLOW_LEADING_WHITESPACE = 0;
  @Deprecated
  int TRIM_LEADING_WHITESPACE = F_TRIM_LEADING_WHITESPACE;
  /**
   * @deprecated ALLOW_LEADING_EOL is now inverted and named F_TRIM_LEADING_EOL
   */
  @Deprecated
  int ALLOW_LEADING_EOL = 0;
  @Deprecated
  int PREFIX_PRE_FORMATTED = F_PREFIX_PRE_FORMATTED;
  @Deprecated
  int FORMAT_ALL = F_FORMAT_ALL;
