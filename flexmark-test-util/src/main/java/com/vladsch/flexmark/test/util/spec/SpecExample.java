...
public class SpecExample {
  ...
  public SpecExample withResourceLocation(@NotNull ResourceLocation location) {
    return new SpecExample(location, lineNumber, optionsSet, section, exampleNumber, source, html, ast, comment, isNull);
  }

  public SpecExample withOptionsSet(@Nullable String optionsSet) {
    return new SpecExample(resourceLocation, lineNumber, optionsSet, section, exampleNumber, source, html, ast, comment, isNull);
  }
