...
public class BitIntegerSet implements Set<Integer>, ReversibleIterable<Integer> {
  ...
  // @formatter:off
  public static @NotNull BitIntegerSet valueOf(@NotNull long[] longs) {
    return new BitIntegerSet(BitSet.valueOf(longs));
  }

  public static @NotNull BitIntegerSet valueOf(@NotNull LongBuffer buffer) {
    return new BitIntegerSet(BitSet.valueOf(buffer));
  }

  public static @NotNull BitIntegerSet valueOf(@NotNull byte[] bytes) {
    return new BitIntegerSet(BitSet.valueOf(bytes));
  }

  public static @NotNull BitIntegerSet valueOf(@NotNull ByteBuffer buffer) {
    return new BitIntegerSet(BitSet.valueOf(buffer));
  }
  ...
  public @NotNull long[] toLongArray() {
    return myBits.toLongArray();
  }
  ...
  public @NotNull BitIntegerSet flip(int i, int i1) {
    myBits.flip(i, i1);
    return this;
  }
  ...
  public @NotNull BitIntegerSet set(int i, boolean b) {
    myBits.set(i, b);
    return this;
  }

  public @NotNull BitIntegerSet set(int i, int i1) {
    myBits.set(i, i1);
    return this;
  }

  public @NotNull BitIntegerSet set(int i, int i1, boolean b) {
    myBits.set(i, i1, b);
    return this;
  }
  ...
  public @NotNull BitIntegerSet clear(int i, int i1) {
    myBits.clear(i, i1);
    return this;
  }

  public @NotNull BitIntegerSet and(@NotNull BitSet set) {
    myBits.and(set);
    return this;
  }

  public @NotNull BitIntegerSet or(@NotNull BitSet set) {
    myBits.or(set);
    return this;
  }

  public @NotNull BitIntegerSet xor(@NotNull BitSet set) {
    myBits.xor(set);
    return this;
  }

  public @NotNull BitIntegerSet andNot(@NotNull BitSet set) {
    myBits.andNot(set);
    return this;
  }

  public @NotNull BitIntegerSet and(@NotNull BitIntegerSet set) {
    myBits.and(set.myBits);
    return this;
  }

  public @NotNull BitIntegerSet or(@NotNull BitIntegerSet set) {
    myBits.or(set.myBits);
    return this;
  }

  public @NotNull BitIntegerSet xor(@NotNull BitIntegerSet set) {
    myBits.xor(set.myBits);
    return this;
  }

  public @NotNull BitIntegerSet andNot(@NotNull BitIntegerSet set) {
    myBits.andNot(set.myBits);
    return this;
  }
  ...
  public @NotNull BitIntegerSet get(int i, int i1) {
    return new BitIntegerSet(myBits.get(i, i1));
  }

  public int nextSetBit(int i) {
    return myBits.nextSetBit(i);
  }

  public int nextClearBit(int i) {
    return myBits.nextClearBit(i);
  }

  public int previousSetBit(int i) {
    return myBits.previousSetBit(i);
  }

  public int previousClearBit(int i) {
    return myBits.previousClearBit(i);
  }

  public boolean intersects(BitSet set) {
    return myBits.intersects(set);
  }
  // @formatter:on

  public @NotNull BitSet bitSet() {
    return myBits;
  }
