...
public class BitFieldSet<E extends Enum<E>> extends AbstractSet<E> implements Cloneable, Serializable {
  ...
  public long mask(E e1, E e2, E e3, E e4) {
    return bitMasks[e1.ordinal()] | bitMasks[e2.ordinal()] | bitMasks[e3.ordinal()] | bitMasks[e4.ordinal()];
  }

  public long mask(E e1, E e2, E e3, E e4, E e5) {
    return bitMasks[e1.ordinal()] | bitMasks[e2.ordinal()] | bitMasks[e3.ordinal()] | bitMasks[e4.ordinal()] | bitMasks[e5.ordinal()];
  }
  ...
  @SafeVarargs
  final public boolean add(E... rest) {
  ...
  @SafeVarargs
  final public boolean remove(E... rest) {
  ...
  @SafeVarargs
  final public boolean any(E... rest) {
  ...
  @SafeVarargs
  final public boolean all(E... rest) {
  ...
  @SafeVarargs
  final public boolean none(E... rest) {
