...
public class BinaryPartAbstractImage {
  ...
  public ByteBuffer getBuffer() {
    return myAbstractImage.getBuffer();
  }

  public byte[] getBytes() {
    return myAbstractImage.getBytes();
  }

  public long getContentLengthAsLoaded() {
    return myAbstractImage.getContentLengthAsLoaded();
  }

  public String getContentType() {
    return myAbstractImage.getContentType();
  }

  public void setContentType(ContentType contentType) {
    myAbstractImage.setContentType(contentType);
  }

  public ExternalTarget getExternalTarget() {
    return myAbstractImage.getExternalTarget();
  }

  @Deprecated
  public ImageInfo getImageInfo() {
    return myAbstractImage.getImageInfo();
  }

  @Deprecated
  public void setImageInfo(ImageInfo imageInfo) {
    myAbstractImage.setImageInfo(imageInfo);
  }

  @Deprecated
  public RelationshipsPart getOwningRelationshipPart() {
    return myAbstractImage.getOwningRelationshipPart();
  }

  @Deprecated
  public void setOwningRelationshipPart(RelationshipsPart owningRelationshipPart) {
    myAbstractImage.setOwningRelationshipPart(owningRelationshipPart);
  }

  public OpcPackage getPackage() {
    return myAbstractImage.getPackage();
  }

  public void setPackage(OpcPackage pack) {
    myAbstractImage.setPackage(pack);
  }

  public PartName getPartName() {
    return myAbstractImage.getPartName();
  }

  public void setPartName(PartName partName) {
    myAbstractImage.setPartName(partName);
  }

  public Relationship getRelLast() {
    return myAbstractImage.getRelLast();
  }

  public String getRelationshipType() {
    return myAbstractImage.getRelationshipType();
  }

  public void setRelationshipType(String relationshipType) {
    myAbstractImage.setRelationshipType(relationshipType);
  }

  public RelationshipsPart getRelationshipsPart() {
    return myAbstractImage.getRelationshipsPart();
  }

  public List<Relationship> getRels() {
    return myAbstractImage.getRels();
  }
  ...
  public void setSourceRelationship(Relationship sourceRelationship) {
    myAbstractImage.setSourceRelationship(sourceRelationship);
  }

  public List<Relationship> getSourceRelationships() {
    return myAbstractImage.getSourceRelationships();
  }

  public long getVersion() {
    return myAbstractImage.getVersion();
  }

  public void setVersion(long version) {
    myAbstractImage.setVersion(version);
  }

  public boolean isLoaded() {
    return myAbstractImage.isLoaded();
  }

  public void setBinaryData(InputStream binaryData) {
    myAbstractImage.setBinaryData(binaryData);
  }

  public void setBinaryData(byte[] bytes) {
    myAbstractImage.setBinaryData(bytes);
  }

  public void setBinaryData(ByteBuffer bb) {
    myAbstractImage.setBinaryData(bb);
  }

  public static void setDensity(int density) {
    org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.setDensity(density);
  }

  public void setRelationships(RelationshipsPart relationships) {
    myAbstractImage.setRelationships(relationships);
  }
  ...
  public static org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage createImagePart(WordprocessingMLPackage wordMLPackage, byte[] bytes) throws Exception {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createImagePart(wordMLPackage, bytes);
  }
  ...
  public static org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage createImagePart(WordprocessingMLPackage wordMLPackage, File imageFile) throws Exception {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createImagePart(wordMLPackage, imageFile);
  }

  @Deprecated
  public static String createImageName(Base sourcePart, String proposedRelId, String ext) {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createImageName(sourcePart, proposedRelId, ext);
  }

  public static String createImageName(OpcPackage opcPackage, Base sourcePart, String proposedRelId, String ext) {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createImageName(opcPackage, sourcePart, proposedRelId, ext);
  }
  ...
  public static org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage createImagePart(OpcPackage opcPackage, Part sourcePart, byte[] bytes, String mime, String ext) throws Exception {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createImagePart(opcPackage, sourcePart, bytes, mime, ext);
  }
  ...
  public static org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage createImagePart(OpcPackage opcPackage, Part sourcePart, byte[] bytes, String mime) throws Exception {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createImagePart(opcPackage, sourcePart, bytes, mime);
  }
  ...
  public static org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage createImagePart(OpcPackage opcPackage, Part sourcePart, File imageFile) throws Exception {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createImagePart(opcPackage, sourcePart, imageFile);
  }
  ...
  public static org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage createLinkedImagePart(WordprocessingMLPackage wordMLPackage, URL fileurl) throws Exception {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createLinkedImagePart(wordMLPackage, fileurl);
  }
  ...
  public static org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage createLinkedImagePart(OpcPackage opcPackage, Part sourcePart, URL url) throws Exception {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.createLinkedImagePart(opcPackage, sourcePart, url);
  }
  ...
  public static void main(String[] args) throws Exception {
    org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.main(args);
  }

  public static void displayImageInfo(ImageInfo info) {
    org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.displayImageInfo(info);
  }

  public static byte[] getImage(WordprocessingMLPackage wmlPkg, Graphic graphic) {
    return org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.getImage(wmlPkg, graphic);
  }

  public static void convertToPNG(InputStream is, OutputStream os, int density) throws IOException, InterruptedException {
    org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.convertToPNG(is, os, density);
  }

  public static void copy2(InputStream is, OutputStream os) throws IOException {
    org.docx4j.openpackaging.parts.WordprocessingML.BinaryPartAbstractImage.copy2(is, os);
  }
  ...
  public Inline createImageInline(String filenameHint, String altText, int id1, int id2) throws Exception {
    return myAbstractImage.createImageInline(filenameHint, altText, id1, id2);
  }

  public Inline createImageInline(String filenameHint, String altText, int id1, int id2, boolean link) throws Exception {
    return myAbstractImage.createImageInline(filenameHint, altText, id1, id2, link);
  }
  ...
  public Inline createImageInline(String filenameHint, String altText, int id1, int id2, boolean link, int maxWidth) throws Exception {
    return myAbstractImage.createImageInline(filenameHint, altText, id1, id2, link, maxWidth);
  }

  @Deprecated
  public Inline createImageInline(String filenameHint, String altText, int id1, int id2, long cx) throws Exception {
    return myAbstractImage.createImageInline(filenameHint, altText, id1, id2, cx);
  }

  public Inline createImageInline(String filenameHint, String altText, int id1, int id2, long cx, boolean link) throws Exception {
    return myAbstractImage.createImageInline(filenameHint, altText, id1, id2, cx, link);
  }
  ...
  public Inline createImageInline(String filenameHint, String altText, int id1, int id2, long cx, long cy, boolean link) throws Exception {
    return myAbstractImage.createImageInline(filenameHint, altText, id1, id2, cx, cy, link);
  }

  public void writeDataToOutputStream(OutputStream out) throws IOException {
    myAbstractImage.writeDataToOutputStream(out);
  }

  public boolean isContentEqual(Part other) throws Docx4JException {
    return myAbstractImage.isContentEqual(other);
  }

  public boolean setPartShortcut(Part part, String relationshipType) {
    return myAbstractImage.setPartShortcut(part, relationshipType);
  }

  public void rename(PartName newName) {
    myAbstractImage.rename(newName);
  }

  public void remove() {
    myAbstractImage.remove();
  }

  public Object getUserData(String key) {
    return myAbstractImage.getUserData(key);
  }

  public void setUserData(String key, Object value) {
    myAbstractImage.setUserData(key, value);
  }

  public RelationshipsPart getRelationshipsPart(boolean createIfAbsent) {
    return myAbstractImage.getRelationshipsPart(createIfAbsent);
  }

  public Relationship addTargetPart(Part targetpart, RelationshipsPart.AddPartBehaviour mode) throws InvalidFormatException {
    return myAbstractImage.addTargetPart(targetpart, mode);
  }

  public Relationship addTargetPart(Part targetpart) throws InvalidFormatException {
    return myAbstractImage.addTargetPart(targetpart);
  }

  public Relationship addTargetPart(Part targetpart, String proposedRelId) throws InvalidFormatException {
    return myAbstractImage.addTargetPart(targetpart, proposedRelId);
  }
  ...
  public Relationship addTargetPart(Part targetpart, RelationshipsPart.AddPartBehaviour mode, String proposedRelId) throws InvalidFormatException {
    return myAbstractImage.addTargetPart(targetpart, mode, proposedRelId);
  }

  public void reset() {
    myAbstractImage.reset();
  }
}
